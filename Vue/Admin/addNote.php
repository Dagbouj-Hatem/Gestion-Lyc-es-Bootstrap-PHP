          ...
          <div class="col-xs-12 col-sm-9 content">
            <div class="panel panel-default">
              <div class="panel-heading">
                <h3 class="panel-title"><a href="javascript:void(0);" class="toggle-sidebar"><span class="fa fa-angle-double-left" data-toggle="offcanvas" title="Maximize Panel"></span></a> ACCUEIL <span class="fa fa-angle-double-right"></span> Matière <span class="fa fa-angle-double-right"></span> Ajouter</h3>
              </div>
              <div class="panel-body">
                  ...
                  <div class="row">
					...
					<?php
						if(isset($_POST['sub']))
						{
							$id_eleve = html_entity_decode(addslashes($_POST['eleve']));
							$id_matiere = html_entity_decode(addslashes($_POST['matiere']));
							$note = html_entity_decode(addslashes($_POST['note']));
							
							include('../../controlleur/ControlleurNote.php');
							include('../../Modele/note.php');
							
							$id_parent = addNote($bdd,$id_eleve,$id_matiere,$note);
							?>
							<div class="alert alert-info alert-dismissable">
							<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
							<strong>Information !</strong> la note est bien ajoutée
						  </div>
							<?php
						}
					...
					?>
                      <form role="form" method="POST" action="?">
                        <div class="form-group">
                          <label for="exampleInputEmail1">Elève *</label>
                          <?php
                        ...
                        <div class="form-group">
                          ...
                          <?php
							include('../../controlleur/ControlleurMatiere.php');
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" required="true" maxlength="7" name="note" class="form-control" id="exampleInputPassword1" placeholder="Note">
                        </div>
