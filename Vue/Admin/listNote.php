          ...
          <div class="col-xs-12 col-sm-9 content">
            <div class="panel panel-default">
              <div class="panel-heading">
                <h3 class="panel-title"><a href="javascript:void(0);" class="toggle-sidebar"><span class="fa fa-angle-double-left" data-toggle="offcanvas" title="Maximize Panel"></span></a> ACCUEIL <span class="fa fa-angle-double-right"></span> Classe <span class="fa fa-angle-double-right"></span> Liste</h3>
              </div>
              <div class="panel-body">
                  ...
                  <div class="row">
                    <div class="panel panel-default">
                    <div class="panel-heading">
                      <div class="panel-title"><b><i class="glyphicon glyphicon-plus"></i> Liste des classes</h2></b>
                      </div>
					...
					?>
                      <form role="form" method="POST" action="?">
                        <div class="form-group">
						  ...
						  <select name="parms" class="selecter_3" data-selecter-options='{"cover":"true"}'>
							...
							<option value="id_eleve">ID élève</option>
							<option value="id_matiere">ID Matière</option>
					  ...
					  <?php
						...
						if(isset($_POST['sub']))
							getListNoteByValue($bdd,$_POST['parms'],$_POST['rech']);
						else
							getListNote($bdd);
					  ?>
                    </div>
