              ...
              <div class="panel-body">
                  ...
                  <div class="row">
					...
					<?php
						if(isset($_POST['sub']))
						{
							$nom = html_entity_decode(addslashes($_POST['lib']));
							$niveau = html_entity_decode(addslashes($_POST['niveau']));
							
							include('../../controlleur/ControlleurClasse.php');
							include('../../Modele/classe.php');
							
							$id_parent = addClasse($bdd,$nom,$niveau);
							?>
							<div class="alert alert-info alert-dismissable">
							<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
							<strong>Information !</strong> le classe est bien ajoutée
						  </div>
							<?php
						}
					...
					?>
                      <form role="form" method="POST" action="?">
                        <div class="form-group">
                          <label for="exampleInputEmail1">Libèlle *</label>
                          <input type="text" required="true" name="lib" class="form-control" id="exampleInputEmail1" placeholder="Libèlle">
                        </div>
                        
                        <div class="form-group">
                          <label for="exampleInputPassword1">Niveau *</label>
                          <input type="text" required="true" maxlength="1" name="niveau" class="form-control" id="exampleInputPassword1" placeholder="Niveau">
                        </div>
