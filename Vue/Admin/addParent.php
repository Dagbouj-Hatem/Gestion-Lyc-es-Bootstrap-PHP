          ...
          <div class="col-xs-12 col-sm-9 content">
            <div class="panel panel-default">
              <div class="panel-heading">
                <h3 class="panel-title"><a href="javascript:void(0);" class="toggle-sidebar"><span class="fa fa-angle-double-left" data-toggle="offcanvas" title="Maximize Panel"></span></a> ACCUEIL <span class="fa fa-angle-double-right"></span> Parents <span class="fa fa-angle-double-right"></span> Ajouter</h3>
              </div>
              <div class="panel-body">
                  ...
                  <div class="row">
                    <div class="panel panel-default">
                    <div class="panel-heading">
                      <div class="panel-title"><b><i class="glyphicon glyphicon-plus"></i> Nouveau Parent</h2></b>
                      </div>
					...
					<?php
						if(isset($_POST['sub']))
						{
							...
							$mail = html_entity_decode(addslashes($_POST['mail']));
							$login = html_entity_decode(addslashes($_POST['login']));
							$pass = html_entity_decode(addslashes($_POST['pass']));
							$tel = html_entity_decode(addslashes($_POST['tel']));
							
							include('../../controlleur/ControlleurParent.php');
							include('../../controlleur/ControlleurEleve.php');
							include('../../Modele/Parent.php');
							
							$id_parent = addParent($bdd,$nom,$prenom,$mail,$login,$pass,$tel);
							?>
							<div class="alert alert-info alert-dismissable">
							<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
							<strong>Information !</strong> le parent est bien ajouté
						  </div>
						  <form role="form" method="POST" action="?">
							<input type="hidden" name="id_parent" value="<?php echo $id_parent; ?>";
							<div class="form-group">
							<?php
							getListClasseParent($bdd);
							
							?>
							<button type="submit" name="sub2" class="btn btn-info">Valider</button>
							</div>
							</form>
							<?php
						}
						else if(isset($_POST['sub2']))
						{
							...
							{
								updateEleve($bdd,$Value,$_POST['id_parent']);
							}
							?>
							<div class="alert alert-info alert-dismissable">
							<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
							...
							<div class="alert alert-info alert-dismissable">
							<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
							<strong>Information !</strong> les élèves sont bien liée avec les parents
							</div>
							<?php
						}
					?>
                      <form role="form" method="POST" action="?">
						...
						<div class="form-group">
                          ...
                          <input type="mail" required="true" name="mail" class="form-control" id="exampleInputPassword1" placeholder="Mail">
                        </div>
                        <div class="form-group">
                          <label for="exampleInputPassword1">login *</label>
                          <input type="text" required="true" name="login" class="form-control" id="exampleInputPassword1" placeholder="Login">
                        </div>
						<div class="form-group">
                          <label for="exampleInputPassword1">Mot de passe *</label>
                          <input type="password" required="true" name="pass" class="form-control" id="exampleInputPassword1" placeholder="Pass">
                        </div>
                        <div class="form-group">
                          <label for="exampleInputPassword1">Téléphone *</label>
                          <input type="text" required="true" maxlength="8" name="tel" class="form-control" id="exampleInputPassword1" placeholder="Numéro">
                        </div>
