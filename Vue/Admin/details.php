          ...
          <div class="col-xs-12 col-sm-9 content">
            <div class="panel panel-default">
              <div class="panel-heading">
                <h3 class="panel-title"><a href="javascript:void(0);" class="toggle-sidebar"><span class="fa fa-angle-double-left" data-toggle="offcanvas" title="Maximize Panel"></span></a> ACCUEIL <span class="fa fa-angle-double-right"></span> élève <span class="fa fa-angle-double-right"></span> Détails</h3>
              </div>
              <div class="panel-body">
                  ...
                  <div class="row">
                    <div class="panel panel-default">
                    <div class="panel-heading">
                      <div class="panel-title"><b><i class="glyphicon glyphicon-plus"></i> Détails</h2></b>
                      </div>
                    ...
                    <div class="row">
								...
								<div class="row">
									...
									<div class="col-lg-6">
										...
										<div class="panel panel-info">
										  <div class="panel-body">
											<?php getListNoteEleve($bdd,$_GET['id']); ?>
										  </div>
										</div>
										<div class="panel-heading">
										  ...
										  <div class="panel-body">
											<form role="form" method="POST" action="<?php echo "?id=".$_GET['id']; ?>">
												<input type="hidden" name="id_eleve" value="<?php echo $_GET['id']; ?>" />
												
												<div class="form-group">
												  <label for="exampleInputPassword1">Message *</label>
												  <input type="text" required="true" name="msg" class="form-control" id="exampleInputPassword1" placeholder="Désignation">
												</div>
									...
									<div class="col-lg-6">
										...
										<div class="panel-heading">
										  ...
										  <div class="panel-body">
										  <button type="button" class="btn btn-info" data-toggle="collapse" data-target="#demo">Marquer Absence</button>
										  <div id="demo" class="collapse">
											<form role="form" method="POST" action="<?php echo "?id=".$_GET['id']; ?>">
												<input type="hidden" name="id_eleve" value="<?php echo $_GET['id']; ?>" />
												<div class="form-group">
												  <label for="exampleInputPassword1">Date *</label>
												  <input type="date" required="true" name="date" class="form-control" id="exampleInputPassword1" placeholder="Date">
												</div>
												<div class="form-group">
												  <label for="exampleInputPassword1">Heure *</label>
												  <input type="time" required="true" name="heure" class="form-control" id="exampleInputPassword1" placeholder="Heure">
												</div>
												<div class="form-group">
												  <label for="exampleInputPassword1">Désignation *</label>
												  <input type="text" required="true" name="desg" class="form-control" id="exampleInputPassword1" placeholder="Désignation">
												</div>
												<button type="submit" name="sub" class="btn btn-info">Valider</button>
												<button type="reset" class="btn btn-danger">Effacer</button>
											  </form>
										  </div>
											<?php getListAbsence($bdd,$_GET['id']);?>
										  </div>
