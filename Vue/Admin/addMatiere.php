                  ...
                  <div class="row">
					...
					<?php
						if(isset($_POST['sub']))
						{
							...
							$coeff = html_entity_decode(addslashes($_POST['coeff']));
							
							include('../../controlleur/ControlleurMatiere.php');
							include('../../Modele/matiere.php');
							
							$id_parent = addMatiere($bdd,$nom,$coeff);
							?>
							<div class="alert alert-info alert-dismissable">
							<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
							<strong>Information !</strong> la matière est bien ajoutée
						  </div>
							<?php
						}
					...
					?>
                      <form role="form" method="POST" action="?">
                        <div class="form-group">
                          <label for="exampleInputEmail1">Nom Matière *</label>
                          <input type="text" required="true" name="nom" class="form-control" id="exampleInputEmail1" placeholder="Nom">
                        </div>
                        
                        <div class="form-group">
                          <label for="exampleInputPassword1">Coefficient *</label>
                          <input type="text" required="true" maxlength="1" name="coeff" class="form-control" id="exampleInputPassword1" placeholder="Coefficient">
                        </div>
